...
def model_predict2(image_path,model):
    ...
    if prediction == 1:
        return "Real","after.html"        
    elif prediction == 0:
        return "Fake","after.html"
...
def predict2():
    ...
    pred, output_page = model_predict2(file_path,model)
...
def predict1():
    ...
    print("@@ Predicting class......")
    clip = mp.VideoFileClip(file_path) #specify the correct file path to your video file 
    clip.audio.write_audiofile(r"static/converted_mp3.wav") #this the name of the coverted audio file
    r = sr.Recognizer()
    audio =sr.AudioFile(r"static/converted_mp3.wav") # give the audio file name here
    ...
    return render_template('result.html',prediction = my_prediction,message=result)
